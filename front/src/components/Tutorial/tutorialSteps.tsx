...
export const dashboardSteps: Step[] = [
  ...
  },
  {
    ...
    content: '탐지된 보안 이벤트의 상세 내역입니다. 서버명, 위협 유형, 심각도를 확인하고 "Go to" 버튼으로 해당 서버로 이동할 수 있습니다.',
    title: 'Detected Threats',
    placement: 'bottom',
  },
  {
    target: '[data-tutorial="threat-categories"]',
    content: 'Tool Poisoning, Command Injection, Filesystem Exposure, PII Leak, Data Exfiltration 등 5가지 위협 유형별 탐지 현황과 영향받은 서버 수를 확인할 수 있습니다.',
    title: 'Threat Categories',
    placement: 'right',
  },
  {
    target: '[data-tutorial="server-chart"]',
    content: '서버별 탐지된 위협 건수를 도넛 차트로 시각화합니다. 어떤 서버가 가장 많은 위협을 받고 있는지 한눈에 파악할 수 있습니다.',
    title: 'Detected Threats per Server',
    placement: 'left',
  },
  {
    target: '[data-tutorial="category-chart"]',
    content: '위협 카테고리별 탐지 건수를 도넛 차트로 표시합니다. 어떤 유형의 위협이 가장 많이 발생하는지 확인할 수 있습니다.',
    title: 'Threats by Category',
    placement: 'left',
  },
  {
    target: '[data-tutorial="timeline"]',
    content: '시간대별 위협 탐지 추이를 라인 차트로 보여줍니다. 언제 가장 많은 보안 이벤트가 발생했는지 확인할 수 있습니다.\n\n다음 단계에서 MCP 서버 상세 화면을 살펴봅니다.',
